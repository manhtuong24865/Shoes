...
import { filterAllProducts } from "../../pages/ProductsPage/api";
...
const HeaderComponent = ({ isHiddenMenu = false }) => {
  ...
  const menus = [
    ...
    },
    {
      ...
      child: [
        ...
        {
          name: "PHỤ KIỆN GIÀY",
          path: "/product?type=phụ kiện giày",
          onClick: () => {
            dispatch(updateCurrentPage(1));
            dispatch(searchProduct("phụ kiện giày"));
            dispatch(updateSearchBy("type"));
          },
        },
      ],
  ...
  const onSearch = (value) => {
    setSearch(value);
    dispatch(filterAllProducts({ search: value }));
    navigate("/product")
  };
  return (
    <div>
